...
--select Sum(tovar.NaSklade) as Na_Firme
--from tovar;
...
--select Count(postachalnik.id_postach) as Podstachalnikiv
--from postachalnik;
...
--select Sum(tovar.Price) as Vsogo 
--from tovar inner join zakaz_tovar on tovar.id_tovar = zakaz_tovar.id_tovar
...
--SELECT postachalnik.Nazva, SUM(zakaz_tovar.Kilkist * tovar.Price) AS Vsogo
--FROM tovar
